        ...
        <div class="card-body">
            <form class="row g-3" method="post" action="/admin/superAdmin">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control @error('id') is-invalid @enderror" name="id" value="{{ $user->name }}"/>
                  <input type="hidden" class="form-control @error('id') is-invalid @enderror" name="id" value="{{ $user->id }}"/>
                </div>
                <div class="col-md-6">
                <label class="form-label">Role</label>
                <select class="form-control @error('status') is-invalid @enderror" name="id_role">
